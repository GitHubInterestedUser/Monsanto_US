	...
	<%-- $Revision: 5268 $ --%>
	<%-- $Date: 2012-12-05 15:10:45 +0530 (Wed, 05 Dec 2012) $ --%>
	<%-- $HeadURL: http://steelscm.domain.steelwedge.com:90/svn/sppm/releases/5.5.0Release/build/efmcore/src/online/app/view_reference_relationships.jsp $ --%>
...
<%   
    ...
    while (iter.hasNext()) {
        ...
        if (referencePK.indexOf("FORECASTING_UNIT-ORG_L4-CUSTOMER-SUPPLY_PLANT_SLOC") >= 0) {
