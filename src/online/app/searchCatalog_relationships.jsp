	...
	<%-- $Revision: 5821 $ --%>
	<%-- $Date: 2012-12-26 15:54:05 +0530 (Wed, 26 Dec 2012) $ --%>
	<%-- $HeadURL: http://steelscm.domain.steelwedge.com:90/svn/sppm/releases/5.5.0Release/build/efmcore/src/online/app/searchCatalog_relationships.jsp $ --%>
...
<%  
    ...
    if(FeatureController.localeSelectOption){
	     ...
	     //commented by Sandeep Kumar Tiwari: Directory Paths formed using key from properties file : 01/02/2012
		//file = new File(".\\applications\\steelwedge\\"+XMLPath).getCanonicalFile();
			String appDirPath=Config.get("ApplicationPath","applications/steelwedge/");
			file = new File(appDirPath+XMLPath).getCanonicalFile();
...
<script language="JavaScript">
	  ...
	  for(var i=0;i<document.searchForm.copyRadio.length;i++){
			...
			if(cart =='copyTo'){
				...
				document.searchForm.searchBy.options[0] = new Option("FORECASTING_UNIT Id","VWPRODUCT_LEAF.LEAF_LABEL");
				document.searchForm.searchBy.options[1] = new Option("FORECASTING_UNIT Desc","VWPRODUCT_LEAF.DESCRIPTION");
				...
				copyFromLevel = document.searchForm.Display.value;
						document.searchForm.searchBy.options[0] = new Option("FORECASTING_UNIT Id","VWPRODUCT_LEAF.LEAF_LABEL");
						document.searchForm.searchBy.options[1] = new Option("FORECASTING_UNIT Desc","VWPRODUCT_LEAF.DESCRIPTION");
						document.searchForm.searchBy.options[2] = new Option("ORG_L4 Id","VWORGANIZATION_LEAF.LEAF_LABEL");
						document.searchForm.searchBy.options[3] = new Option("ORG_L4 Desc","VWORGANIZATION_LEAF.DESCRIPTION");
						document.searchForm.searchBy.options[4] = new Option("CUSTOMER Id","VWGEOGRAPHY_LEAF.LEAF_LABEL");
						document.searchForm.searchBy.options[5] = new Option("CUSTOMER Desc","VWGEOGRAPHY_LEAF.DESCRIPTION");
						searchByNameArray[0] = "FORECASTING_UNIT Id";
						searchByNameArray[1] = "FORECASTING_UNIT Desc";
						searchByNameArray[2] = "ORG_L4 Id";
						searchByNameArray[3] = "ORG_L4 Desc";
						searchByNameArray[4] = "CUSTOMER Id";
						searchByNameArray[5] = "CUSTOMER Desc";
						searchByValueArray[0] = "VWPRODUCT_LEAF.LEAF_LABEL" ;
						searchByValueArray[1] = "VWPRODUCT_LEAF.DESCRIPTION";
						searchByValueArray[2] = "VWORGANIZATION_LEAF.LEAF_LABEL";
						searchByValueArray[3] = "VWORGANIZATION_LEAF.DESCRIPTION";
						searchByValueArray[4] = "VWGEOGRAPHY_LEAF.LEAF_LABEL";
						searchByValueArray[5] = "VWGEOGRAPHY_LEAF.DESCRIPTION";
						searchByTypeArray[0] = 2;
						searchByTypeArray[1] = 2;
						searchByTypeArray[2] = 2;
						searchByTypeArray[3] = 2;
						searchByTypeArray[4] = 2;
						searchByTypeArray[5] = 2;
			}
